                    ...
                    <header>
                        <div class="row">
                            <div class="col-sm-6 col-print-6">
                                <img src="<?php echo base_url();?>assets/back/demo/img/logo/invoice-logo.png" alt="Logo" class="invoice-logo"/>
                            </div>
                            <div class="col-sm-6 col-print-6">
                        ...
                        <div class="row mb-lg">
                            ...
                            <section class="col-sm-6 col-print-6 text-align-right">
                                ...
                                <address>
                                    ...
                                    <abbr title="Work email">e-mail:</abbr> <a href="mailto:#">cynthiandirangu@gmail.com</a><br>
                                    <abbr title="Work Phone">phone:</abbr> (012) 345-678-901<br>
                                    <abbr title="Work Fax">fax:</abbr> (012) 678-132-901
