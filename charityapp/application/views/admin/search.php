            ...
            <div class="col-lg-9 col-lg-pull-3">
                ...
                <section class="search-result-item">
                    <a class="image-link" href="#">
                        <img class="image" src="<?php echo base_url();?>assets/back/demo/img/pictures/1.jpg">
                    </a>
                ...
                <section class="search-result-item">
                    <a class="image-link" href="#">
                        <img class="image" src="<?php echo base_url();?>assets/back/demo/img/pictures/5.jpg">
                    </a>
                    <div class="search-result-item-body">
                        <div class="row">
                            <div class="col-sm-9">
                                <h4 class="search-result-item-heading">
                                    ...
                                    <span class="badge bg-danger fw-normal pull-right">Best Deal!</span>
                                </h4>
                                <p class="info">
                ...
                <section class="search-result-item">
                    <a class="image-link" href="#">
                        <img class="image" src="<?php echo base_url();?>assets/back/demo/img/pictures/13.jpg">
                    </a>
                    <div class="search-result-item-body">
                        <div class="row">
                            <div class="col-sm-9">
                ...
                <section class="search-result-item">
                    <a class="image-link" href="#">
                        <img class="image" src="<?php echo base_url();?>assets/back/demo/img/pictures/3.jpg">
                    </a>
                    <div class="search-result-item-body">
                        <div class="row">
                            <div class="col-sm-9">
