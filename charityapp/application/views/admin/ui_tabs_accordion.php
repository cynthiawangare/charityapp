            ...
            <div class="col-md-6">
                <div class="clearfix">
                    <ul id="tabs1" class="nav nav-tabs pull-left"> <!-- remove pull-left to get a cool effect too -->
                        ...
                        <li class=""><a href="#tab2" data-toggle="tab">Assumtion</a></li>
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Dropdown <b class="caret"></b></a>
                            <ul class="dropdown-menu">
                                <li class=""><a href="#tab3" tabindex="-1" data-toggle="tab">@fat</a></li>
                                <li class=""><a href="#tab4" tabindex="-1" data-toggle="tab">@mdo</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
            ...
            <div class="col-md-6">
                <div class="tabbable tabs-right">
                    <ul id="tabs3" class="nav nav-tabs">
                        <li class=""><a href="#tab13" data-toggle="tab">Basic</a></li>
                        <li class=""><a href="#tab23" data-toggle="tab">Assumtion</a></li>
                        <li class="active"><a href="#tab33"  data-toggle="tab">Works</a></li>
                    </ul>
